...
protected:
  ...
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr rotation_shim_controller_sigh_sub_;
  void rotation_shim_controller_sigh_callback(const std_msgs::msg::Bool &msg);
...
#endif  // NAV2_ROTATION_SHIM_CONTROLLER__NAV2_ROTATION_SHIM_CONTROLLER_HPP_// Copyright (c) 2021 Samsung Research America
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at
