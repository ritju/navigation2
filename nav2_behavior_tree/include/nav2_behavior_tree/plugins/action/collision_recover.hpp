...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__COLLISION_RECOVER_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__COLLISION_RECOVER_HPP_
 ...
 */
class CollisionRecover : public BtActionNode<capella_ros_msg::action::Empty>
{
public:
  /**
